...
{
    public abstract class ItemInfoUI : MonoBehaviour
    {
        ...
        public void OnSlotSelected(ItemSO item, GameObject slot)
        {
            _item = item;
            _slotPrefab = slot;
        ...
        private void UpdateItemInfo()
        {
            ...
            if (_item is EquipmentSO equipment)
                ShowEquipmentStats(equipment);
            else
                _itemStats.text = string.Empty;
        }

        private void ShowEquipmentStats(EquipmentSO equipment) => _itemStats.text = equipment.EquipmentStats.ToString();
